...
namespace OlaWakeel.Migrations
{
    ...
    [Migration("20201221143418_lawyerthreeproperties")]
    partial class lawyerthreeproperties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlaWakeel.Models.ContactUs", b =>
                {
                    ...
                    b.Property<string>("ContactUs_PhoneNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OlaWakeel.Models.FavouriteLawyer", b =>
                {
                    b.Property<int>("FavouriteLawyerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OlaWakeel.Models.Log", b =>
                {
                    ...
                    b.Property<int?>("AppointmentAppoinmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppointmentAppoinmentId");

                    b.ToTable("Logs");
                });

            modelBuilder.Entity("OlaWakeel.Models.Notification", b =>
                {
                    ...
                    b.Property<bool>("NotificationSeen")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("OlaWakeel.Models.PaymentMethods", b =>
                {
            ...
            modelBuilder.Entity("OlaWakeel.Models.RescheduleAppoint", b =>
                {
                    b.Property<int>("RescheduleAppoint_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("RescheduleAppoint_Id");

                    b.ToTable("RescheduleAppoints");
                });
            ...
            modelBuilder.Entity("OlaWakeel.Models.Withdraw", b =>
                {
                    b.Property<int>("Withdraw_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OlaWakeel.Models.Log", b =>
                {
                    b.HasOne("OlaWakeel.Models.Appointment", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentAppoinmentId");
                });
